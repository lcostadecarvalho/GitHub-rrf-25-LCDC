...
%%% iebaltab hh_size n_child_5 n_elder read sick female_head livestock_now area_acre_w drought_flood crop_damage, grpvar(treatment) rowvarlabels format(%9.2f) savecsv("//data4/users6/lcostadecarvalho/My Documents/github/GitHub-rrf-25-LCDC/Stata/Outputs/balance") savetex("//data4/users6/lcostadecarvalho/My Documents/github/GitHub-rrf-25-LCDC/Stata/Outputs/balance") nonote addnote(" Significance: ***=.01, **=.05, *=.1") replace
